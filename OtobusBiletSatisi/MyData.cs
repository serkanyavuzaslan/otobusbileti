...
namespace OtobusBiletSatisi
{
    public static class MyData
    {
        ...
        public static DataTable DataTable_Otobus()
        {
            ...
            table_otobus.Rows.Add(recno, "22 OTO 46", 47);
            table_otobus.Rows.Add(recno, "34 OTO 47", 47);
            table_otobus.Rows.Add(recno, "35 OTO 48", 47);
            table_otobus.Rows.Add(recno, "45 OTO 49", 47);
